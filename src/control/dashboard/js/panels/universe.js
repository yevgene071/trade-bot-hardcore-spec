...
function renderUniverse(data) {
  ...
  if (filterRow) {
    ...
    ['ALL', 'Ready', 'Trading'].forEach(f => {
      ...
      chip.addEventListener('click', () => { setUniFilter(f); renderUniverse(data); });
